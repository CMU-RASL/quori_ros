DEMO_MESSAGES = {
    ...
    'Introduction':{
        'Greeting':
            ['Hello {name}, my name is Quori, and the other robot next to us is my friend Frida. I will be leading you through the exercise session today. Frida will draw for you, and the details of the drawing will be based on your movements. We hope it motivates you during your exercises.'],
        ...
        'Great':
            [' Great! Thank you for choosing. Frida will now start drawing to get a headstart.'],
