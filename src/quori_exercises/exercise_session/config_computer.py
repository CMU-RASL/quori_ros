...
with open('/home/roshni/quori_files/quori_ros/src/quori_exercises/experts/new_experts_smaller.pickle', 'rb') as handle:
...
for e in ['bicep curls', 'lateral raises']:
    ...
    for f in ['low', 'moderate', 'high']:
        with open('/home/roshni/quori_files/quori_ros/src/quori_exercises/exercise_session/{}_{}_edited.json'.format(e, f)) as file:
